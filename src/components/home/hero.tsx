        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-left max-w-2xl">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-bold font-heading leading-[1.1] mb-6 text-balance"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed text-balance"
            >
            ...
            >
              ...
              <Button variant="outline" size="xl" className="border-2 border-primary/20 hover:border-primary/60 bg-transparent text-primary hover:text-primary hover:bg-primary/5 transition-all duration-300" asChild>
                <Link href="/portfolio" className="group justify-center flex items-center font-bold text-primary hover:text-primary">
            ...
            >
              ...
              {["React", "Next.js", "Node.js", "Python", "AWS", "TypeScript"].map((tech) => (
                <span
                  key={tech}
                  className="px-2.5 py-1 text-xs font-medium rounded-full bg-muted/60 text-muted-foreground border border-border/40 backdrop-blur-sm"
                >
                  {tech}
                </span>
              ))}
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-accent/30 rounded-3xl blur-2xl opacity-50" />
            
            {/* Code Window */}
            <div className="relative rounded-2xl border bg-slate-950/80 backdrop-blur-xl p-5 shadow-2xl overflow-hidden font-mono text-left max-w-lg mx-auto">
            ...
            <motion.div
              ...
              className="absolute -bottom-8 -left-8 p-4 rounded-xl border bg-card/90 backdrop-blur-xl shadow-2xl max-w-[200px]"
            >
              <div className="text-xs text-muted-foreground font-medium mb-1">Project Growth</div>
              <div className="text-2xl font-bold font-heading text-primary">+250%</div>
              <div className="h-10 w-full mt-3 flex items-end gap-1">

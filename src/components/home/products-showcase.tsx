      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <SectionHeader
            ...
            subtitle="Discover our suite of SaaS products designed to solve real-world business challenges."
          />
        </ScrollReveal>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {products.map((product) => (
            <StaggerItem key={product.slug}>
              <div className="group relative p-8 rounded-2xl border bg-card hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-1 overflow-hidden">
                {/* Background gradient */}
                ...
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <h3 className="text-2xl font-heading font-bold mt-3">
                        {product.name}
                      </h3>

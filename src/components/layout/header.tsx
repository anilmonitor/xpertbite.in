...
import { Menu, ChevronDown, ArrowRight, Code2, Database, Users, BookOpen, CreditCard, Mail, Search } from "lucide-react";
...
export function Header() {
  ...
  return (
    <>
      <header
        className={cn(
          "fixed top-0 left-0 right-0 z-50 transition-all duration-300 shadow-[0_1px_3px_rgba(0,0,0,0.06)]",
          scrolled
            ? "glass-nav shadow-[0_2px_8px_rgba(0,0,0,0.08)]"
            : "bg-transparent"
        )}
      >
          ...
          <nav className="flex items-center justify-between h-16 lg:h-18">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-3.5 py-1.5 text-xs text-muted-foreground bg-muted/60 hover:bg-muted hover:text-foreground border border-border/80 rounded-full transition-all duration-200 shadow-sm"
                aria-label="Search"
              >
              ...
              <Button
                ...
                size="icon"
                onClick={() => setSearchOpen(true)}
                className="sm:hidden hover:bg-primary/10 rounded-xl text-muted-foreground hover:text-foreground"
                aria-label="Search"
              >
                ...
                <SheetContent side="right" className="w-[300px] bg-background/95 dark:bg-slate-950/95 backdrop-blur-xl border-l border-border p-5 overflow-y-auto flex flex-col justify-between">
                  ...
                  <div className="flex-1 flex flex-col justify-start">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2.5 px-3.5 py-2.5 mb-5 text-sm text-muted-foreground bg-muted/60 hover:bg-muted border border-border/80 rounded-xl transition-colors text-left"
                    >

    ...
    <PublicLayout>
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative max-w-4xl">
          <ScrollReveal>
            <SectionHeader title="Refund Policy" subtitle="Last Updated: July 13, 2026" />
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade-up">
            <div className="prose prose-slate dark:prose-invert mt-8 space-y-6 text-muted-foreground leading-relaxed">
              ...
              <p>
                For subscriptions purchased under our products (such as TaskForge or Invoicely), we offer a 14-day money-back guarantee. If you are unsatisfied with the SaaS platform, you can email billing@xpertbite.in to request a full refund within 14 days of purchase.
              </p>
